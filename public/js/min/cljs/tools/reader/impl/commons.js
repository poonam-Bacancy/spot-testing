...
var G__15099 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__15099;
continue;
} else {
return ch;
...
var vec__15100 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__15100,(0),null);
return (match === s);
});
...
var len__10184__auto___15105 = arguments.length;
var i__10185__auto___15106 = (0);
while(true){
if((i__10185__auto___15106 < len__10184__auto___15105)){
args__10191__auto__.push((arguments[i__10185__auto___15106]));

var G__15107 = (i__10185__auto___15106 + (1));
i__10185__auto___15106 = G__15107;
continue;
} else {
}
break;
...
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__10192__auto__);
});
...
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq15103){
var G__15104 = cljs.core.first.call(null,seq15103);
var seq15103__$1 = cljs.core.next.call(null,seq15103);
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic(G__15104,seq15103__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__15108__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__15108 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__15109__i = 0, G__15109__a = new Array(arguments.length -  1);
while (G__15109__i < G__15109__a.length) {G__15109__a[G__15109__i] = arguments[G__15109__i + 1]; ++G__15109__i;}
  _ = new cljs.core.IndexedSeq(G__15109__a,0,null);
} 
return G__15108__delegate.call(this,rdr,_);};
G__15108.cljs$lang$maxFixedArity = 1;
G__15108.cljs$lang$applyTo = (function (arglist__15110){
var rdr = cljs.core.first(arglist__15110);
var _ = cljs.core.rest(arglist__15110);
return G__15108__delegate(rdr,_);
});
