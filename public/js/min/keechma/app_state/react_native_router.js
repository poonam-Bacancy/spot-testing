...
return keechma.app_state.react_native_router.update_navigation_key.call(null,cljs.core.update.call(null,cljs.core.update.call(null,route,new cljs.core.Keyword(null,"index","index",-1531685915),cljs.core.inc),new cljs.core.Keyword(null,"routes","routes",457900162),(function (p1__28334_SHARP_){
return cljs.core.conj.call(null,p1__28334_SHARP_,value);
})));
});
...
keechma.app_state.react_native_router.ReactNativeRouter.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this__9604__auto__,k__9605__auto__){
var self__ = this;
var this__9604__auto____$1 = this;
return this__9604__auto____$1.cljs$core$ILookup$_lookup$arity$3(null,k__9605__auto__,null);
});

keechma.app_state.react_native_router.ReactNativeRouter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__9606__auto__,k28339,else__9607__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k28339,else__9607__auto__);

}
});

keechma.app_state.react_native_router.ReactNativeRouter.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (this__9618__auto__,writer__9619__auto__,opts__9620__auto__){
var self__ = this;
...
keechma.app_state.react_native_router.ReactNativeRouter.prototype.cljs$core$IMeta$_meta$arity$1 = (function (this__9602__auto__){
var self__ = this;
var this__9602__auto____$1 = this;
return self__.__meta;
});

keechma.app_state.react_native_router.ReactNativeRouter.prototype.cljs$core$ICloneable$_clone$arity$1 = (function (this__9599__auto__){
var self__ = this;
...
keechma.app_state.react_native_router.ReactNativeRouter.prototype.cljs$core$ICounted$_count$arity$1 = (function (this__9608__auto__){
var self__ = this;
...
keechma.app_state.react_native_router.ReactNativeRouter.prototype.cljs$core$IHash$_hash$arity$1 = (function (this__9600__auto__){
var self__ = this;
...
return (-1415765247 ^ cljs.core.hash_unordered_coll.call(null,coll__9601__auto__));
...
keechma.app_state.react_native_router.ReactNativeRouter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this28340,other28341){
var self__ = this;
var this28340__$1 = this;
return (!((other28341 == null))) && ((this28340__$1.constructor === other28341.constructor)) && (cljs.core._EQ_.call(null,this28340__$1.routes_chan,other28341.routes_chan)) && (cljs.core._EQ_.call(null,this28340__$1.watch_id,other28341.watch_id)) && (cljs.core._EQ_.call(null,this28340__$1.app_db,other28341.app_db)) && (cljs.core._EQ_.call(null,this28340__$1.__extmap,other28341.__extmap));
});

keechma.app_state.react_native_router.ReactNativeRouter.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__9613__auto__,k__9614__auto__){
var self__ = this;
...
return (new keechma.app_state.react_native_router.ReactNativeRouter(self__.routes_chan,self__.watch_id,self__.app_db,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__9614__auto__)),null));
}
});

keechma.app_state.react_native_router.ReactNativeRouter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__9611__auto__,k__9612__auto__,G__28338){
var self__ = this;
var this__9611__auto____$1 = this;
var pred__28344 = cljs.core.keyword_identical_QMARK_;
var expr__28345 = k__9612__auto__;
if(cljs.core.truth_(pred__28344.call(null,new cljs.core.Keyword(null,"routes-chan","routes-chan",1367675796),expr__28345))){
return (new keechma.app_state.react_native_router.ReactNativeRouter(G__28338,self__.watch_id,self__.app_db,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__28344.call(null,new cljs.core.Keyword(null,"watch-id","watch-id",1539926919),expr__28345))){
return (new keechma.app_state.react_native_router.ReactNativeRouter(self__.routes_chan,G__28338,self__.app_db,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__28344.call(null,new cljs.core.Keyword(null,"app-db","app-db",865606302),expr__28345))){
return (new keechma.app_state.react_native_router.ReactNativeRouter(self__.routes_chan,self__.watch_id,G__28338,self__.__meta,self__.__extmap,null));
} else {
return (new keechma.app_state.react_native_router.ReactNativeRouter(self__.routes_chan,self__.watch_id,self__.app_db,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__9612__auto__,G__28338),null));
}
}
}
});

keechma.app_state.react_native_router.ReactNativeRouter.prototype.cljs$core$ISeqable$_seq$arity$1 = (function (this__9616__auto__){
var self__ = this;
var this__9616__auto____$1 = this;
return cljs.core.seq.call(null,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"routes-chan","routes-chan",1367675796),self__.routes_chan],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"watch-id","watch-id",1539926919),self__.watch_id],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"app-db","app-db",865606302),self__.app_db],null))], null),self__.__extmap));
});

keechma.app_state.react_native_router.ReactNativeRouter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__9603__auto__,G__28338){
var self__ = this;
var this__9603__auto____$1 = this;
return (new keechma.app_state.react_native_router.ReactNativeRouter(self__.routes_chan,self__.watch_id,self__.app_db,G__28338,self__.__extmap,self__.__hash));
});

keechma.app_state.react_native_router.ReactNativeRouter.prototype.cljs$core$ICollection$_conj$arity$2 = (function (this__9609__auto__,entry__9610__auto__){
var self__ = this;
...
keechma.app_state.react_native_router.ReactNativeRouter.cljs$lang$ctorPrSeq = (function (this__9642__auto__){
return cljs.core._conj.call(null,cljs.core.List.EMPTY,"keechma.app-state.react-native-router/ReactNativeRouter");
});

keechma.app_state.react_native_router.ReactNativeRouter.cljs$lang$ctorPrWriter = (function (this__9642__auto__,writer__9643__auto__){
return cljs.core._write.call(null,writer__9643__auto__,"keechma.app-state.react-native-router/ReactNativeRouter");
});
...
keechma.app_state.react_native_router.map__GT_ReactNativeRouter = (function keechma$app_state$react_native_router$map__GT_ReactNativeRouter(G__28342){
return (new keechma.app_state.react_native_router.ReactNativeRouter(new cljs.core.Keyword(null,"routes-chan","routes-chan",1367675796).cljs$core$IFn$_invoke$arity$1(G__28342),new cljs.core.Keyword(null,"watch-id","watch-id",1539926919).cljs$core$IFn$_invoke$arity$1(G__28342),new cljs.core.Keyword(null,"app-db","app-db",865606302).cljs$core$IFn$_invoke$arity$1(G__28342),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__28342,new cljs.core.Keyword(null,"routes-chan","routes-chan",1367675796),new cljs.core.Keyword(null,"watch-id","watch-id",1539926919),new cljs.core.Keyword(null,"app-db","app-db",865606302))),null));
});
