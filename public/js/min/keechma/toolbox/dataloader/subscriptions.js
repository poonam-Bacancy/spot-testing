...
return cljs.core.reduce.call(null,(function (acc,p__27590){
var vec__27591 = p__27590;
var datasource_key = cljs.core.nth.call(null,vec__27591,(0),null);
var datasource = cljs.core.nth.call(null,vec__27591,(1),null);
return cljs.core.assoc.call(null,cljs.core.assoc.call(null,acc,cljs.core.keyword.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,datasource_key)),"-meta"].join('')),((function (vec__27591,datasource_key,datasource){
return (function (app_db_atom){
return reagent.ratom.make_reaction.call(null,((function (vec__27591,datasource_key,datasource){
return (function (){
...
});})(vec__27591,datasource_key,datasource))
);
});})(vec__27591,datasource_key,datasource))
),datasource_key,((function (vec__27591,datasource_key,datasource){
return (function (app_db_atom){
return reagent.ratom.make_reaction.call(null,((function (vec__27591,datasource_key,datasource){
return (function (){
var app_db = cljs.core.deref.call(null,app_db_atom);
