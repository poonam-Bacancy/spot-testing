...
var G__20979 = cljs.core.first.call(null,element_str);
switch (G__20979) {
case "?":
arr.push((1));
...
var G__20981 = cljs.core.next.call(null,items);
items = G__20981;
continue;
} else {
return null;
...
var G__20982 = cljs.core.next.call(null,items);
items = G__20982;
continue;
} else {
return null;
...
var G__20984 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__20984;
continue;
} else {
return true;
...
switch (G__20987) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__20987){
return (function (p1__20985_SHARP_){
return cljs.core.not_EQ_.call(null,p1__20985_SHARP_,(2));
});})(G__20987))
))){
...
return cljs.core.not_EQ_.call(null,p1__20986_SHARP_,(1));
});})(G__20987))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20987)].join('')));
